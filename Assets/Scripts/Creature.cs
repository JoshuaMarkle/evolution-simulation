...
public class Creature : MonoBehaviour 
{
    ...
    private List<Transform> nearbyFood = new List<Transform>();
    private Vector2 closestFood;
    ...
    void SetState() 
    {
        ...
        float energyCost = Mathf.Pow(moveSpeed, 2) * viewDistance / 100000f;
        energy -= energyCost * Master.Instance.energyDialator + Time.deltaTime / 20f;
        if (energy <= 0f) 
        {
    ...
    // Assign Characteristics and Features Based on the Genome
    void InheritGenome() 
    {
    ...
    // Detect Food Entering View Area
